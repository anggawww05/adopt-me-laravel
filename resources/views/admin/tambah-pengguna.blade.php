...
@section('container')
    <div class="ml-64 p-8 bg-gray-50 min-h-screen ">
        ...
        <form action="{{ route('admin.pengguna.store') }}" method="POST" enctype="multipart/form-data"
            class="bg-white rounded-lg shadow-md p-8 w-full">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="password_confirmation" class="block text-gray-700 font-medium mb-2">Konfirmasi Kata
                    Sandi</label>
                <input type="password"
                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <div class="mb-5">
                ...
                <input
                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    id="address" name="address" rows="2" required></input>
            </div>
            <div class="mb-5">
                <label for="picture_profile" class="block text-gray-700 font-medium mb-2">Foto Profil</label>
                <input type="file"
                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                    id="picture_profile" name="picture_profile" accept="image/*">
            </div>
            <div class="mb-8">
            ...
            <button type="submit"
                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-md transition duration-200">Simpan</button>
        </form>
    </div>
@endsection
