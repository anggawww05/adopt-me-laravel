...
<head>
    ...
    {{-- 1. Mengimpor Font Montserrat dari Google Fonts --}}
...
<body class="font-sans bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <ul class="flex items-center space-x-6 lg:space-x-8 text-gray-700 text-sm lg:text-base">
                <li><a href="#" class="hover:font-semibold transition duration-200">Home</a></li>
                <li><a href="#" class="hover:font-semibold transition duration-200">Adopt</a></li>
                <li><a href="#" class="hover:font-semibold transition duration-200">Rehome</a></li>
                <li><a href="#" class="hover:font-semibold transition duration-200">Tentang Kami</a></li>
            </ul>

            {{-- Tombol Login / Sign Up --}}
            <a href="#" class="flex items-center space-x-2 bg-[#D678D6] text-white font-semibold rounded-lg hover:opacity-70 transition duration-200 px-4 py-2 lg:px-6 lg:py-3 text-sm lg:text-base">
                {{-- Ikon juga dibuat responsif --}}
                ...
                {{-- Hapus kelas font dari span agar mewarisi dari parent --}}
    ...
    <footer class="bg-white shadow-outer">
            ...
            <div class="container mx-70 px-6 py-20">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div>
                        <h3 class="text-base lg:text-lg font-semibold text-gray-800 mb-4">Butuh bantuan?</h3>
                        <ul class="space-y-3">
                            ...
                            <li><a href="#" class="text-sm lg:text-base text-[#5E225E] hover:text-[#D678D6] hover:underline transition">Adopt FAQ's</a></li>
                            <li><a href="#" class="text-sm lg:text-base text-[#5E225E] hover:text-[#D678D6] hover:underline transition">Rehome FAQ's</a></li>
                        </ul>
                    </div>

                    {{-- Kolom 2: Hubungi kami --}}
                    <div>
                        <h3 class="text-base lg:text-lg font-semibold text-gray-800 mb-4">Hubungi kami</h3>
                        <ul class="space-y-4">
                            {{-- Alamat --}}
            ...
            <div class="bg-[#D678D6]">
                <div class="container mx-auto px-6 py-4">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        ...
                        {{-- Ikon Sosial Media (Menggunakan SVG Anda + Dibuat Responsif) --}}
